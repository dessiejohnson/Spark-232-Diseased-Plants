...
Some future improvements that could be done for this multiclass classification task is use a more advanced model like Convolutional Neural Network (CNN) which will likely deliver better image classification accuracy.
